<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@rumble-finance/sor">
...
SOR exists in the Bronze release as a way to aggregate liquidity across all Rumble pools. Future releases of Rumble will accomplish this on-chain and allow aggregate contract fillable liquidity.

Liquidity aggregators are free to use the SOR npm package or create their own order routing across pools.

[Read More](https://docs.rumble.finance/developers/smart-order-router)
